...
const handleSubmit = async () => {
  try {
    loading.value = true
    error.value = null
    await racesStore.createRace(newRace.value)
    router.push('/races')
  } catch (err) {
      ...
      <div class="md:flex md:items-center md:justify-between">
        <div class="min-w-0 flex-1">
          ...
          <p class="mt-1 text-sm text-gray-500">
            Completa la información para crear una nueva carrera
          </p>
        </div>
      </div>
    </div>
