...
const handleExport = async () => {
  await ridersStore.exportRiders()
}
...
const handleUpdateRider = async () => {
  try {
    await ridersStore.updateRider(riderToEdit.value.id, editRider.value)
    showEditModal.value = false
    riderToEdit.value = null
    // Reset form
    editRider.value = {
      firstName: '',
      lastName: '',
...
<template>
  <div>
    ...
    <div v-if="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      <!-- Background overlay -->
      <div class="fixed inset-0 bg-black bg-opacity-20 transition-opacity" @click="showCreateModal = false"></div>
        ...
        <div class="p-6">
          <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">
            Nuevo Corredor
                ...
                <form @submit.prevent="handleCreateRider">
                  ...
                  <div class="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
                    <button
                      type="submit"
                      class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bmx-gradient text-base font-medium text-white hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:col-start-2 sm:text-sm"
                    >
                      Crear Corredor
                    </button>
                    <button
    ...
    <div v-if="showEditModal" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      <!-- Background overlay -->
      <div class="fixed inset-0 bg-black bg-opacity-20 transition-opacity" @click="showEditModal = false"></div>
        ...
        <div class="p-6">
          <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">
            Editar Corredor
                ...
                <form @submit.prevent="handleUpdateRider">
                  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                      <label class="block text-sm font-medium text-gray-700">Nombre</label>
                      <input
